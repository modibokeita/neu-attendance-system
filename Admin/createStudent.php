...
if(isset($_POST['addStudent'])){
  ...
  $folderPath = "../Student/labels/{$registrationNumber}/";
  ...
  file_put_contents($folderPath . '2.png', $imageData2);
    ...
    $query=mysqli_query($conn,"insert into tblstudents(firstName,lastName,email,registrationNumber,faculty,courseCode,studentImage1,studentImage2,dateRegistered, password) 
    value('$firstName','$lastName','$email','$registrationNumber','$faculty','$courseCode', '$registrationNumber" . "_image1.png', '$registrationNumber" . "_image2.png','$dateRegistered', '$password')");
